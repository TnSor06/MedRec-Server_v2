...
const viewMedicalPractitionerSchema = Joi.object().keys({
  id: Joi.string().required(),
});
async function meMedicalPractitioner(parent, args, { prisma, request }, info) {
...
async function viewMedicalPractitioner(
  parent,
  args,
  { prisma, request },
  info
) {
  const result = await viewMedicalPractitionerSchema.validate({
    id: args.id,
  });
  if (result.error) {
...
async function registerMedicalPractitioner(
  parent,
  args,
  { prisma, request },
  info
) {
  const result = await registerMedicalPractitionerSchema.validate({
...
async function updateMedicalPractitioner(
  parent,
  args,
  { prisma, request },
  info
  ...
  const result = await updateMedicalPractitionerSchema.validate({
    address: args.data.address,
