...
async function createPatientCase(parent, args, { prisma, request }, info) {
  const result = await createPatientCaseSchema.validate({
...
async function viewPatientCase(parent, args, { prisma, request }, info) {
...
export { createPatientCase, viewPatientCase, PatientCase };
