...
async function addInsurance(parent, args, { prisma, request }, info) {
  const result = await addInsuranceSchema.validate({
...
async function updateInsurance(parent, args, { prisma, request }, info) {
  const result = await updateInsuranceSchema.validate({
    insuranceStatus: args.data.insuranceStatus,
    insuranceCompany1: args.data.insuranceCompany1,
    insuranceCompany2: args.data.insuranceCompany2,
    sponsorerDetails: args.data.sponsorerDetails,
...
export { addInsurance, updateInsurance };
